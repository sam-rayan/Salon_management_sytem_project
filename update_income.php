...
if (isset($_POST['id'])) {
    ...
    $sql = "SELECT * FROM income_details WHERE id = $id";
    ...
    if ($result->num_rows > 0) {
        ...
        $sql_insert = "INSERT INTO iupdated (bname, service, money, method, dte)
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['new_bname'])) {
            ...
            $sql_update = "UPDATE income_details SET bname = '$new_bname', money = '$new_money', method = '$new_method' WHERE id = $id";
