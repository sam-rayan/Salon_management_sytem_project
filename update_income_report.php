...
if (isset($_POST['update'])) {
    ...
    $sql_update = "UPDATE iupdated SET bname = '$bname', service = '$service', money = '$money', method = '$method', dte = '$date' WHERE id = '$id'";
...
$sql = "SELECT * FROM iupdated WHERE bname LIKE '%$searchName%'";
...
<body>
  <div class='report-container'>
    ...
    $sql_all = "SELECT * FROM iupdated WHERE bname LIKE '%$searchName%'";
