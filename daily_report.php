...
// SQL to fetch records for today
$sql = "SELECT * FROM income_details WHERE DATE(dte) = '$today'";
$result = $con->query($sql);

// Calculate the total money for today
$totalMoney = 0;
...
// HTML to display the daily report
echo "<!DOCTYPE html>
<html lang='en'>
<head>
  <meta charset='UTF-8'>
...
<body>
  <div class='report-container'>
    ...
    if ($result->num_rows > 0) {
        ...
        // Display the total money for today
        echo "</table>
              <div class='total'>Total Money for Today: " . number_format($totalMoney, 2) . "</div>";
    } else {
